import { CreateCustomerInputModel, CreateCustomerUseCase, CreateCustomerViewModel } from "../../../application";
...
const input: CreateCustomerInputModel = {
  name: "John Doe",
  address: {
    street: "Street",
    number: 123,
...
describe("Unit Test create customer usecase", () => {
  it("should create customer", async () => {
    ...
    const outputExpected: CreateCustomerViewModel = {
